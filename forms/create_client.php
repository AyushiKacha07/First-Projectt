      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: times new roman; color: darkmagenta;">clientEnquiry Form</h3></div>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: deeppink;">client Enquiry Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
...
<form action="submit_client.php" method="POST">
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" id="aadhar" name="aadhar" rows="2" required></textarea>
  </div>
