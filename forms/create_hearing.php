      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="font-family: times new roman; color: darkmagenta;">Hearing Form</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Hearing Form</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style= " color: deeppink;">Hearing Form</h3>
                      <button
                        type="button"
                        class="btn btn-tool"
                  ...
                  <div class="card-body">
<form action="submit_hearing.php" method="POST">

    <div class="mb-3">
        <label for="hearing_id" class="form-label">Hearing ID</label>
        <input type="text" class="form-control" id="hearing_id" name="hearing_id" required>
    </div>
