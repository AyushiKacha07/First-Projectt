          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="Create_payment.php" class="btn btn-primary" name="save" value="create">
                 Payment Form
                </a>
              </div>
            </div>
...
<div class="container mt-5">
  <h2 class="mb-4 text-primary" style="font-family: Times New Roman;">💳 Payment Records</h2>
  <table id="paymentTable" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="delete_payment.php?id=<?= $row['payment_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this payment?');">Delete</a>
        </td>
      </tr>
      <?php endwhile; else: ?>
      <tr>
    ...
    <tfoot>
      <tr>
        ...
        <th>Payment Date</th>
        <th>Payment Mode</th>
        <th></th> <!-- No search for Edit -->
        <th></th> <!-- No search for Delete -->
      </tr>
    </tfoot>
