...
if (
    !isset(
        $_POST['lawyer_id'], $_POST['case_type'],
...
// Get values
$lawyer_id = (int)trim($_POST['lawyer_id']);
...
// Prepare SQL
$stmt = $conn->prepare("INSERT INTO cases (lawyer_id, case_type, case_description, case_status, start_date, end_date) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param('isssss', $lawyer_id, $case_type, $case_description, $case_status, $start_date, $end_date);
